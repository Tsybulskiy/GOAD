Remove-GPLink -Name "StarkWallpaper" -Target "OU=Testers,OU=kingdoms,DC=programmers,DC=local" -erroraction 'silentlycontinue'
...
New-GPLink -Name "Remove-StarkWallpaper" -Target "OU=Testers,OU=kingdoms,DC=programmers,DC=kzi"
